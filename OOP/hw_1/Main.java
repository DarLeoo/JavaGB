...
public class Main {
    public static void main(String[] args) {
        ...
        machine.addProduct(new Perishable("Молоко Бурёнка", 85, new Date(2022,1,25)));
        machine.addProduct(new Perishable("Молоко Коровка", 85, new Date(2022, 1, 25)));
        machine.addProduct(new Perishable("Молоко Василёк", 85, new Date(2022, 1, 25)));
